...
var valores = [] //vetor usado para analisar dos dados


function isNumero(n) { /*recebe apenas 1 parametro */
/*verificar se **n** é número */
...
function inLista(n, l) { /*recebe 2 parametro*/
    if (l.indexOf(Number(n)) != -1) { /*-1 indica não foi encontrado na lista*/
        return true
    } else {
        return false
    }
...
function adicionar() {
    //só vai adicionar se não estiver em lista (!inLista())
